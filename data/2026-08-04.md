...
### [60] [Cost-Effective Automated Judging of Natural-Language Mathematical Proofs](https://arxiv.org/abs/2608.00004)
*Benjamin Grayzel*
...
### [61] [RubricReviewer: From Direct Critique to Objective and Comprehensive Rubric-Driven Peer Review](https://arxiv.org/abs/2608.00005)
...
### [62] [MemoryForge: Synthesize Lifelong Memory for Human-Like LLM Agents](https://arxiv.org/abs/2608.00007)
...
### [63] [AgentMemBench: A Systematic Benchmark for Evaluating Long-Term Memory Management Strategies in Conversational AI Agents](https://arxiv.org/abs/2608.00009)
*Ahmed Cherif*
...
### [64] [DLLM-TTS: Block Discrete Diffusion Language Model for Text-to-Speech Synthesis](https://arxiv.org/abs/2608.00011)
...
### [65] [Obshazard-bench: Benchmarking Multimodal Foundation Models for Real-Time Disaster Intelligence from Raw Earth Observation Streams](https://arxiv.org/abs/2608.00012)
...
### [66] [What Transfers from Text to Vision? Capability Scaling Laws and Transfer Dynamics for VLMs](https://arxiv.org/abs/2608.00013)
...
### [67] [Role Steering of Language Models for Social Simulations](https://arxiv.org/abs/2608.00023)
...
### [68] [Exploring More to Solve More: Boosting Diversity in Text Diffusion Models via Entropy-Based Guidance](https://arxiv.org/abs/2608.00024)
...
### [69] [SLMs as Multi-Agent Routers: A Progressive SFT and Reinforcement Learning Approach](https://arxiv.org/abs/2608.00030)
...
### [70] [XL-DocBench: Benchmarking Evidence-Grounded Extra-Long Document Understanding](https://arxiv.org/abs/2608.00036)
...
### [71] [Trustworthiness Costs of Domain Adaptation in Small Language Models:A Cross-Architecture Empirical Study](https://arxiv.org/abs/2608.00042)
...
### [72] [Predicting Startup Exit from Textual Descriptors - A Computational Linguistics Framework](https://arxiv.org/abs/2608.00045)
...
### [73] [Neural Circuit Function Inference with LLMs](https://arxiv.org/abs/2608.00059)
...
### [74] [LLM-OSDA: An Optimal-Stopping Dynamic Auction for Native Advertising in Multi-Turn LLM Conversations](https://arxiv.org/abs/2608.00123)
...
### [75] [DiffusionGemma Technical Report](https://arxiv.org/abs/2608.00146)
...
### [76] [A Constitution-Grid Instrument for Data-Efficient RL Alignment (C-Guard)](https://arxiv.org/abs/2608.00180)
*Lily Zhang*
...
### [77] [Averaging Bias: Human Faithfulness Annotations are not Locally Faithful](https://arxiv.org/abs/2608.00205)
...
### [78] [Bridging the English-Arabic Medical Knowledge Gap: Targeted Low-Rank Adaptation via Causal Layer Selection](https://arxiv.org/abs/2608.00207)
...
### [79] [A Few Neurons Reveal When LLMs Misuse Tools: Sparse Detection and Selective Steering for Reliable Tool Use](https://arxiv.org/abs/2608.00218)
...
### [80] [Cross-Task Dissociation in Frontier Vision-Language Model Theory of Mind](https://arxiv.org/abs/2608.00261)
...
### [81] [Sixteen models, fewer than two voices: measuring ensemble dispersion where no answer is uniquely correct](https://arxiv.org/abs/2608.00285)
...
### [82] [Comparing and Modeling Argumentation in German Political Communication across Arenas](https://arxiv.org/abs/2608.00288)
...
### [83] [SeDeM: Selective Decompression of Hidden-State Memories for Long-Context Question Answering](https://arxiv.org/abs/2608.00311)
...
### [84] [CurveShift: Is Agent Progress Scalar? Separating Level from Shape](https://arxiv.org/abs/2608.00355)
...
### [85] [Deep Research Pretraining via Predictive Navigation](https://arxiv.org/abs/2608.00432)
...
### [86] [AdaMTP: An Adaptive Training Paradigm for Multi-Token Prediction](https://arxiv.org/abs/2608.00434)
...
### [87] [SERL-SQL: Selective Hindsight Distillation for Text-to-SQL Reinforcement Agentic Learning](https://arxiv.org/abs/2608.00485)
...
### [88] [The methodology of Constructing the Large-Scale Dataset for Detecting Presuicidal and Anti-Suicidal Signals in Social Media Texts in Russian](https://arxiv.org/abs/2608.00497)
...
### [89] [The Learning Objective Governs Perceptual Narrowing: A Cross-Lingual, Layer-Wise, Ten-Seed Study of Self-Supervised Speech Encoders](https://arxiv.org/abs/2608.00507)
*Sejin Yoo*
...
### [90] [Rethinking and formalising the state across languages: a unified computational learning theory account](https://arxiv.org/abs/2608.00523)
*Mohamed El Idrissi*
...
### [91] [S$^4$R: Selective Sampling, Subspaces, and Sparse Reconstruction for Compressed Long-Context KV Caching](https://arxiv.org/abs/2608.00528)
...
### [92] [Native Multilingual Chain-of-Thought Reasoning in Low-Resource Southeast Asian Languages](https://arxiv.org/abs/2608.00533)
...
### [93] [DE-NER : Zero-shot Named Entity Recognition via Dialogue Elicitation of Large Language Models](https://arxiv.org/abs/2608.00538)
...
### [94] [Loanword or Switch? The Annotation Boundary, Not the Model, Drives Kazakh-Russian Code-Switching Identification](https://arxiv.org/abs/2608.00581)
*Bogdan Savelyev*
...
### [95] [Writing-System-Level Tokenizer Adaptation for Byte-Level BPE](https://arxiv.org/abs/2608.00582)
*Bohdan Didenko*
...
### [96] [Verification Without Sufficiency: Per-Chunk Filtering Fails on Multi-Hop RAG, and Decomposition Repairs It](https://arxiv.org/abs/2608.00585)
*Randhir Kumar*
...
### [97] [A Heuristic Perspective on Debiasing Language Models](https://arxiv.org/abs/2608.00622)
...
### [98] [TreeProbe : A Tibetan Medicine Benchmark for Cultural Bias in LLMs](https://arxiv.org/abs/2608.00640)
...
### [99] [Select-And-Extract: A Lightweight Plugin for Retrieval-Augmented Generation](https://arxiv.org/abs/2608.00658)
...
### [100] [OpenART: Scaling Agent Red Teaming via Open-Ended Environment Evolution](https://arxiv.org/abs/2608.00677)
...
### [101] [AttnLink: Turning Attention into Schema Links for Text-to-SQL](https://arxiv.org/abs/2608.00693)
...
### [102] [Exploiting Intrinsic Duality for Multi-Hop Question Generation](https://arxiv.org/abs/2608.00712)
...
### [103] [Observatorio Lazaro: A self-populating database of anglicism usage in the Spanish press](https://arxiv.org/abs/2608.00713)
...
### [104] [RAGOCR: Optical Compression of Retrieval-Augmented Text via Visual Representation](https://arxiv.org/abs/2608.00765)
...
### [105] [Distill Where You Fail: Recovering Learning Signals of Negative RL-Groups from Adaptive Teacher Guidance](https://arxiv.org/abs/2608.00782)
...
### [106] [OoO-Spec: Out-of-Order Semantic Speculation for Fast Tool Calling](https://arxiv.org/abs/2608.00814)
...
### [107] [Exemplars in Disguise: Pure Exemplar Models Mimic Abstraction-First Learning](https://arxiv.org/abs/2608.00821)
...
### [108] [Pruned BPE: Post-training Visibility Pruning and Token Reallocation for Byte Pair Encoding](https://arxiv.org/abs/2608.00837)
*Kenny Shao*
...
### [109] [Practical Online KV Cache Compaction for LLM Agents: An Empirical Study](https://arxiv.org/abs/2608.00902)
...
### [110] [FinHardBench: Can LLMs Generate Latency-Aware Hardware for Financial Computing?](https://arxiv.org/abs/2608.00909)
...
### [111] [Gaokerena: A Small Persian Medical Language Model Family](https://arxiv.org/abs/2608.00932)
...
### [112] [Mind the Gap: Zero-Query Jailbreaks via Filter-Generator Discrepancy in Text-to-Image Systems](https://arxiv.org/abs/2608.00973)
...
### [113] [Unsupervised Multidomain Approaches to Named Entity Recognition with Small Datasets](https://arxiv.org/abs/2608.00984)
...
### [114] [MedUPS: Towards Diagnostic Assistance in Uncommon Medical Cases with Large Language Models](https://arxiv.org/abs/2608.01012)
...
### [115] [Cloud-ScPO: Hidden-State Geometry for Semi-Supervised Preference Optimization in LLM Reasoning](https://arxiv.org/abs/2608.01014)
...
### [116] [Why LLMs Give In: Conversational Factors and Reasoning Behind Medical Sycophancy](https://arxiv.org/abs/2608.01017)
...
### [117] [Opt.Gear Technical Report](https://arxiv.org/abs/2608.01034)
...
### [118] [DeBERTa-Sentinel: Toward Transparent and Trustworthy Detection of AI-Generated Text](https://arxiv.org/abs/2608.01046)
...
### [119] [Track-Guided Hierarchical Reinforcement Learning for Autonomous Vehicle Drifting with Minimum-Lap-Time Planning](https://arxiv.org/abs/2608.00113)
...
### [120] [Motion Planning for Mobile Manipulators Navigating Doorways via Model Predictive Control](https://arxiv.org/abs/2608.00206)
...
### [121] [Developing Combined Manipulation and Locomotion Skills with Interaction Representation and Skill Composition](https://arxiv.org/abs/2608.00208)
...
### [122] [Compliant Sphere Lattice Contact: Distributed Contact Modeling for Sphere-Based Robot Representations](https://arxiv.org/abs/2608.00263)
...
### [123] [Localization in Spatiotemporal Fields via Environmental PDEs](https://arxiv.org/abs/2608.00272)
...
### [124] [Hybrid Attention Estimation Pipeline for Adaptive HRI Using an Expressive Robotic Head](https://arxiv.org/abs/2608.00284)
...
### [125] [Towards General Language-Conditioned Latent Safety Filters](https://arxiv.org/abs/2608.00315)
...
### [126] [Belief-Space Perception Routing under Coupled Sensor Faults and Compute Contention](https://arxiv.org/abs/2608.00322)
...
### [127] [Action Chunk Scheduling for Batched Robot Policy Serving](https://arxiv.org/abs/2608.00337)
...
### [128] [A Robotic System for Automated Manufacturing of Dielectric Elastomer Actuators](https://arxiv.org/abs/2608.00369)
...
### [129] [The Gate, Not the Cache: Gate Provenance Bounds the Closed-Loop Reliability of Training-Free VLA Token Skipping](https://arxiv.org/abs/2608.00391)
...
### [130] [Embodied Passive Aeroacoustic Perception Enables Relative Sensing and Pursuit Between Aerial Robots](https://arxiv.org/abs/2608.00401)
...
### [131] [Learning to Predict Contact Force Distributions from Vision Leveraging Object Geometry Priors](https://arxiv.org/abs/2608.00464)
...
### [132] [From Digital to Physical Reservoir Computing: Co-Optimizing Soft Robotic Reservoirs via Dynamics Matching](https://arxiv.org/abs/2608.00484)
...
### [133] [First Deployable Dynamic-CoM: A Unified Policy and Method-Agnostic Benchmark for Humanoid Single-Leg Balance](https://arxiv.org/abs/2608.00500)
...
### [134] [SSTG-Nav: Metric-Grounded Spatial-Semantic Topological Graphs for Reusable Object Navigation](https://arxiv.org/abs/2608.00527)
...
### [135] [Disentangling Visuo-Tactile Foresight: Oracle-Guided Interface Discovery for World Action Models](https://arxiv.org/abs/2608.00547)
...
### [136] [DexMani: Human-Derived Manipulability Guidance for Dexterous Rotation](https://arxiv.org/abs/2608.00554)
...
### [137] [Latency-Tolerant Cloud-Edge Collaborative Vision-Language-Action Models via Emergent Representational Specialization](https://arxiv.org/abs/2608.00569)
...
### [138] [Grasp Execution Without a Planner: Configuration-Space Grasp Distance Fields with Certified Safety & Guaranteed Quality](https://arxiv.org/abs/2608.00600)
...
### [139] [From Failures to Supervision: DynamicEnvPlan for Robust Long-Horizon Embodied Planning](https://arxiv.org/abs/2608.00613)
...
### [140] [Learning-Based Motion Planning for Dynamic Environments: From Foundational Algorithms to Emerging Paradigms](https://arxiv.org/abs/2608.00625)
...
### [141] [FlowPilot: Real-Time World-Action Modeling for Agile UAV Navigation](https://arxiv.org/abs/2608.00635)
...
### [142] [Assistant Placement Aria: A Benchmark for Egocentric Placement Assistance](https://arxiv.org/abs/2608.00652)
...
### [143] [Staged Multi-Agent Training (SMAT) for Hip Exoskeletons: Metabolic and Biomechanical Validation of a Simulation-Trained Co-Adaptive Controller](https://arxiv.org/abs/2608.00715)
...
### [144] [OmniAI: A Surface-Adaptive Aerial Projection Interface for Human--Drone Interaction](https://arxiv.org/abs/2608.00721)
...
### [145] [SelfWAM: A Self-Grounded Unified World Action Model for Fast Robot Control](https://arxiv.org/abs/2608.00725)
...
### [146] [Push-Wiper: Toward General-Purpose Robotic Cleaning across Varied Stains and Surfaces with Segmented Pushing Trajectories](https://arxiv.org/abs/2608.00730)
...
### [147] [When Prompts Control Robots: Prompt Injection Attacks in Multi-Agent Robotic Systems](https://arxiv.org/abs/2608.00747)
...
### [148] [ORCESTRA: VLM-driven Visual Robot programming in Mixed Reality](https://arxiv.org/abs/2608.00775)
...
### [149] [SIPTraj: Map-Free End-to-End Trajectory Prediction via Physics-Guided Scene Interaction](https://arxiv.org/abs/2608.00779)
...
### [150] [StochSIPP: Safe Interval Path Planning in Stochastic Dynamic Environments](https://arxiv.org/abs/2608.00792)
...
### [151] [DynamicWAM: Dual-Path Motion Conditioning for World-Action Models in Dynamic Manipulation](https://arxiv.org/abs/2608.00793)
...
### [152] [LooperMuscle: Fast and Stable Learning of Humanoid Whole-Body Tracking via Structured Mixture-of-Experts](https://arxiv.org/abs/2608.00820)
...
### [153] [RIT*: Riemannian Informed Trees for Cost-Adaptive Optimal Motion Planning](https://arxiv.org/abs/2608.00822)
...
### [154] [GeminiPainter's sequence-formed pipeline comprised of perception, cognition, planning, and action stages](https://arxiv.org/abs/2608.00829)
...
### [155] [Minute-Scale Training for Microrobot Navigation](https://arxiv.org/abs/2608.00854)
...
### [156] [Bicycle Acrobatics with Reinforcement Learning](https://arxiv.org/abs/2608.00880)
...
### [157] [Stipple: Real-Time Incremental Gaussian Splatting with Visual-Inertial Tracking](https://arxiv.org/abs/2608.00931)
...
### [158] [VertiAKD: Adaptive Off-Road Kinodynamics on Vertically Challenging Terrain](https://arxiv.org/abs/2608.00945)
...
### [159] [GraRe: Grasp Candidate Re-Ranking for Frozen 6-DoF Grasp Detectors](https://arxiv.org/abs/2608.00946)
...
### [160] [FreqNav: Stage-Wise Frequency Routing for Object-Oriented Aerial Vision-Language Navigation](https://arxiv.org/abs/2608.00970)
...
### [161] [RL Bootstrapping of OpenVLA-OFT for a Novel Robot Embodiment](https://arxiv.org/abs/2608.01013)
...
### [162] [KING: Embodiment-Aware Kinematic Graph Neural Network for Unified Motion Representation of Legged and Wheeled Robots](https://arxiv.org/abs/2608.01015)
...
### [163] [Sampling-Based Visibility Task Planning](https://arxiv.org/abs/2608.01027)
...
### [164] [VLAGuard: A Framework for Evaluating and Mitigating Physical Attention Hijacking in Vision-Language-Action Robots within Wireless Sensor Networks](https://arxiv.org/abs/2608.01028)
...
### [165] [Diffusion-Based Body Schema Learning Enabling Abnormal-State Adaptation in Musculoskeletal Robots](https://arxiv.org/abs/2608.01029)
...
### [166] [WAM-Diff2: Hierarchical AR-to-Diffusion Distillation for Highly Efficient Autonomous Driving VLA](https://arxiv.org/abs/2608.01035)
...
### [167] [OC-VLA++: Monocular Geometry-Guided Cross-View Consistency for Viewpoint-Robust Robotic Manipulation](https://arxiv.org/abs/2608.01066)
...
### [168] [VespaSeg: A Resource-Aware Ground-then-Segment Pipeline for Referring Expression Segmentation](https://arxiv.org/abs/2608.01077)
...
### [169] [Sparse Meets Dense: Correspondence Guided Robotic Manipulation with Rigid-Deformable Interactions](https://arxiv.org/abs/2608.01083)
...
### [170] [CAAT: Contact-Aware Attention Scaling and Tactile Masking for Data-Efficient Contact-Rich Manipulation](https://arxiv.org/abs/2608.01102)
...
### [171] [FeDepth: Federated Learning for Depth Estimation under Robot Heterogeneity](https://arxiv.org/abs/2608.01129)
...
### [172] [Complete Motion Planning using Workspace-Fibered Decomposition for nR-Planar Manipulator](https://arxiv.org/abs/2608.01172)
...
### [173] [PRISM: Privileged Probabilistic Latent Supervision for End-to-End Autonomous Driving Motion Planning](https://arxiv.org/abs/2608.01201)
...
### [174] [EndoWAM: A Grounded World-Action Model for Generalizable Endoscopic Navigation](https://arxiv.org/abs/2608.01221)
...
### [175] [Hermite Curves as Trajectory Priors for Vision-Language-Action Models](https://arxiv.org/abs/2608.01265)
...
### [176] [DreamTrajectory: Trajectory-Guided Action Generation with World Model Alignment for Mobile Manipulation](https://arxiv.org/abs/2608.01381)
...
### [177] [SG-WAM: Self-Guided World Modeling in Geometry-Aware Policy Space](https://arxiv.org/abs/2608.01397)
...
### [178] [Demystifying When and Why VLAs Fail in Contact-Rich Tasks and How to Fix Them](https://arxiv.org/abs/2608.01402)
...
### [179] [Revisiting Classic Thought Experiments to Measure Consciousness for Artificial Intelligence Safety](https://arxiv.org/abs/2608.00001)
*Peter David Fagan*
...
### [180] [AutoFOAM: The Self-Refining Autonomous OpenFOAM Agent](https://arxiv.org/abs/2608.00003)
...
### [181] [Enhancing LLMs with Context-Specific Knowledge for Mitigating Misinformation in SMEs: A RAG-based Modeling and Analysis](https://arxiv.org/abs/2608.00006)
...
### [182] [Energy Efficiency of Locally Deployed LLMs: A Preliminary Quantitative GPU Power Benchmark on Consumer Hardware](https://arxiv.org/abs/2608.00008)
...
### [183] [CoT-Core: Accelerating LLM Evaluation via CoT-Aware Coreset Selection](https://arxiv.org/abs/2608.00014)
...
### [184] [Optimization and Constraint Modeling using LLMs with a Retrieval Augmented Generation Process](https://arxiv.org/abs/2608.00015)
...
### [185] [Memory Reward Inflation in Self-Improving LLM Agents](https://arxiv.org/abs/2608.00017)
...
### [186] [Request-Level Energy Attribution for Batched LLM Serving](https://arxiv.org/abs/2608.00026)
...
### [187] [Motif-Mamba: network motif improved mamba for long-range sequence modeling](https://arxiv.org/abs/2608.00027)
...
### [188] [Nova: An End-to-End MLIR Compiler for Deep Learning](https://arxiv.org/abs/2608.00029)
...
### [189] [SIRIN: A Unified Toolkit for Detecting Contextual Hallucinations in Retrieval-Augmented and Memory-Grounded LLM Systems](https://arxiv.org/abs/2608.00033)
...
### [190] [Linguistic Context Recodes Visual Representations in Vision-Language Models](https://arxiv.org/abs/2608.00035)
...
### [191] [RAG-TESTER: Automated End-to-End Testing of Retrieval-Augmented Large Language Models](https://arxiv.org/abs/2608.00054)
...
### [192] [H+ Embedding: Harmonizing Global and Token-Level Retrieval with Context-Dependent Phrases](https://arxiv.org/abs/2608.00065)
...
### [193] [Agentic Coding in the Wild: Characterizing GitHub Copilot Traces at Production Scale](https://arxiv.org/abs/2608.00101)
...
### [194] [Can LLM Agents Price Competitively? A Dynamic Multi-Attribute Auction Benchmark for Agentic Commerce](https://arxiv.org/abs/2608.00102)
...
### [195] [Shared Organizational Memory for Enterprise Coding Agents: System Design and Deployment Snapshot](https://arxiv.org/abs/2608.00122)
...
### [196] [AgentStream: How Well Do Self-Evolving LLM Agents Perform Under Streaming Tasks?](https://arxiv.org/abs/2608.00155)
...
### [197] [TRACE-TS: Attribution-Grounded and Traceable Sensor-Language Reasoning for Human Activity Understanding](https://arxiv.org/abs/2608.00200)
...
### [198] [Personalizing Large Language Model Agents with Small Policy Models](https://arxiv.org/abs/2608.00215)
...
### [199] [More Debate, Same Evidence: Structural Limits of Homogeneous Multi-Agent Groundedness](https://arxiv.org/abs/2608.00243)
*Yuelyu Ji*
...
### [200] [Geometric Self-Supervised Pre-training for Neural Combinatorial Optimization](https://arxiv.org/abs/2608.00270)
...
### [201] [RF-HOI: Recognize Human-Object Interaction with Radio Frequency Signals](https://arxiv.org/abs/2608.00289)
...
### [202] [WM-Cov: Test Adequacy for Interactive World-Model-Style Autonomous Driving Simulation](https://arxiv.org/abs/2608.00298)
...
### [203] [CrystalMem: Elastic Memory for Self-Evolving LLM Agents via Knowledge Crystallization](https://arxiv.org/abs/2608.00303)
...
### [204] [Trust and Its Betrayal under Three Representational Strategies](https://arxiv.org/abs/2608.00321)
...
### [205] [Learning to Coordinate Symbolic Tools: LLM Agents for Verified Sum-of-Squares Certificates](https://arxiv.org/abs/2608.00326)
...
### [206] [RMSWeb: Reflection, Failure-Mode Mining, and Salvage-DS for Web Agent Reinforcement Learning](https://arxiv.org/abs/2608.00335)
...
### [207] [Bayesian and Motivated Reasoning in AI Agents](https://arxiv.org/abs/2608.00339)
*Eddie Yang*
...
### [208] [Gene Ontology-Guided Hierarchical Spatial Gene Expression Prediction from Histopathology Images](https://arxiv.org/abs/2608.00405)
...
### [209] [Where did the ambiguity go? Examining how multimodal models interpret polysemous words](https://arxiv.org/abs/2608.00410)
...
### [210] [SymboUQ: Symbolic Uncertainty Quantification for Spatial Reasoning in LLMs](https://arxiv.org/abs/2608.00417)
...
### [211] [Mask-Based Priors Are More Persistent than Query-Key Initializations](https://arxiv.org/abs/2608.00418)
...
### [212] [TrAC: Trace-Conditioned Answer Consistency for Efficient Uncertainty Quantification in LLMs](https://arxiv.org/abs/2608.00422)
*Dahai Yu,Lin Jiang,Rongchao Xu,Guang Wang*
...
### [213] [Diagnose Before You Compress: Prediction-Independent Bottleneck Witness Refinement for LLM Serving Traces](https://arxiv.org/abs/2608.00423)
...
### [214] [Ekova: A Personality-Support Agent for Self-Discovery Dialogue](https://arxiv.org/abs/2608.00478)
*Yuyan Chen*
...
### [215] [F-WANDA: Fisher-Reweighted Post-Training Pruning for Sustainable Deployment of Large Language Models](https://arxiv.org/abs/2608.00481)
*Himanshu Mishra*
...
### [216] [The Bayesian Reflex: A Predictive Coding Engine for Artificial Intelligence](https://arxiv.org/abs/2608.00492)
...
### [217] [TaPR: Test-Aware Policy Refinement for Feedback-Conditioned Code Generation](https://arxiv.org/abs/2608.00494)
...
### [218] [BayesSeg: A Bayesian Optimization Framework for State Segmentation of Electricity Consumption Time Series](https://arxiv.org/abs/2608.00513)
...
### [219] [CURE: Local Uncertainty Repair for Block-Parallel Speculative Decoding](https://arxiv.org/abs/2608.00531)
*Aofan Liu,Jingxiang Meng,Fangxin Liu,Yongbiao Chen*
...
### [220] [Through the LENS: Local Geometric Decomposition of Vision-Language Model Representations](https://arxiv.org/abs/2608.00561)
...
### [221] [Why Does the Future Branch? Identifiable Closure Tests for Stochastic Physical World Models](https://arxiv.org/abs/2608.00591)
*Yibin Dong*
...
### [222] [Escaping Confidence Trap: Evolutionary Decoding for Mathematical Reasoning in Diffusion LLMs](https://arxiv.org/abs/2608.00605)
...
### [223] [Slides2MindMap: Reconstructing Cognitively Efficient Knowledge Hierarchies from Lecture Slides](https://arxiv.org/abs/2608.00610)
...
### [224] [DASH: Decoupled Adaptive Surrogate - Acquisition Harness for Automated Bayesian Optimization](https://arxiv.org/abs/2608.00641)
...
### [225] [HetGPS: Scalable Graph Multi-Agent Reinforcement Learning with Physics-Anchored Adaptive Safety for EV Charging](https://arxiv.org/abs/2608.00679)
...
### [226] [Multi-Dimensional Assessment for AI Cognition (MAAC): A Theoretical Framework for Process-Oriented Cognitive Evaluation of Text-Based AI Systems](https://arxiv.org/abs/2608.00680)
...
### [227] [When Does LLM Orchestration Pay Off? A Controlled Evaluation of Accuracy, Cost, and Task Difficulty](https://arxiv.org/abs/2608.00685)
...
### [228] [Evolutionary Curriculum Learning Improves Biological Sequence Modeling](https://arxiv.org/abs/2608.00697)
...
### [229] [DGA$_2$D: Directed Graph-Guided Automated Algorithm Design with Large Language Models](https://arxiv.org/abs/2608.00700)
...
### [230] [Tracing the Cascade: A Topology-Aware Evaluation Framework for Scientific Agent Hallucinations](https://arxiv.org/abs/2608.00711)
...
### [231] [AI-Based Thesis Assessment: An Empirical Study of Human Evaluation Priorities and Their Impact on Automated Assessment](https://arxiv.org/abs/2608.00717)
...
### [232] [Behavioral Grammar: Detecting Adaptive Malware via Tiny Language Model Priors and Second-Order Temporal Analysis](https://arxiv.org/abs/2608.00745)
*Zihan Luo*
...
### [233] [FinDeepIndicator: Benchmarking Deep Research Agents in End-to-End Financial Indicator Construction](https://arxiv.org/abs/2608.00764)
...
### [234] [Measurement Without Validity: The Compounding Reliability Problem in Agentic AI Evaluation](https://arxiv.org/abs/2608.00794)
*William Caban*
...
### [235] [AgentSLABench: Evaluating and Benchmarking Agentic Systems Under Resource Constraints](https://arxiv.org/abs/2608.00805)
...
### [236] [Large language models improve physician accuracy but lead to false reliance](https://arxiv.org/abs/2608.00817)
...
### [237] [The Scaling Paradox in Human-AI Collaboration](https://arxiv.org/abs/2608.00818)
...
### [238] [Uncertainty-Aware Simulation-Based Inference for Operations Research with Large Language Models](https://arxiv.org/abs/2608.00019)
...
### [239] [Learning Compositional Meta-Routing for Agentic Workflows: An Executable Benchmark](https://arxiv.org/abs/2608.00106)
...
### [240] [MetaRoute-Bench: Evaluating Meta-Decision Policies for Agentic Workflow Routing](https://arxiv.org/abs/2608.00107)
*Natan Vidra,Alina Kapanova,Arun Kanhai,Spurthi Setty*
...
### [241] [Progressive$^2$: A Teacher-Student Progressive Co-Evolving Knowledge Distillation Method for Substantial Model Compression](https://arxiv.org/abs/2608.00129)
...
### [242] [Rethinking Pretraining for Specialized Design Data: Evidence from the JONES-19 Cultural Design Dataset](https://arxiv.org/abs/2608.00135)
...
### [243] [Leak It: A Probabilistic Approach to Training-Data Extraction from Black-Box Language Models](https://arxiv.org/abs/2608.00144)
*Victor Maricato*
...
### [244] [Response Magnitude as a Dominant Signal for Held-Out CRISPRi Perturbation Effect Prediction](https://arxiv.org/abs/2608.00152)
...
### [245] [Inference-Time Policy Alignment for Fair Reinforcement Learning](https://arxiv.org/abs/2608.00175)
...
### [246] [AutoCause: A Python framework that automates expert decisions in environmental time-series causal discovery](https://arxiv.org/abs/2608.00198)
...
### [247] [A Physics-Chemistry-Informed Neural Network (PCINN) for Real-Time Spatial-ALD Coverage Prediction and Reliable Kinetics Inversion](https://arxiv.org/abs/2608.00212)
...
### [248] [Verifier-Induced Support Reshaping in On-Policy Optimization](https://arxiv.org/abs/2608.00220)
...
### [249] [Similarity-Aware Machine Unlearning](https://arxiv.org/abs/2608.00246)
...
### [250] [Stabilized Best-of-$K$ Training for Neural Combinatorial Optimization](https://arxiv.org/abs/2608.00296)
...
### [251] [Abstention as an Action Can Kill Both the Reward Gradient and the KL Anchor: Collapse Law and Repair for Error-Penalized Reinforcement Learning](https://arxiv.org/abs/2608.00301)
...
### [252] [Agentic Bayesian Optimization through Surrogate-Augmented Autoresearch](https://arxiv.org/abs/2608.00316)
...
### [253] [Neural operator learning for collision-aware trajectory planning of spacecraft swarms](https://arxiv.org/abs/2608.00320)
...
### [254] [Ensemble of Unsupervised Deep Learning for Clustering Imbalanced Tabular Data](https://arxiv.org/abs/2608.00346)
...
### [255] [Modeling Unknown Nonlocal PDE Systems via Flow Map Learning](https://arxiv.org/abs/2608.00400)
...
### [256] [DSETA: A Dual-Stage Continual Learning Framework for Travel Time Prediction in Dynamic Traffic Environments](https://arxiv.org/abs/2608.00402)
...
### [257] [Unleashing the Potential of Large Language Models: A Blueprint for Real-Time, Enterprise-Ready Deployments](https://arxiv.org/abs/2608.00419)
...
### [258] [HP-JEPA: Hierarchical Partitioning for Multi-Resolution Graph Joint-Embedding Predictive Learning](https://arxiv.org/abs/2608.00491)
...
### [259] [Agentic Graph Token Reasoning](https://arxiv.org/abs/2608.00542)
*Zhuoyi Peng,Yi Yang*
...
### [260] [Crushing the Evidence: A Dual-Penalty Evasion Framework for Fooling White-Box Explainable AI Auditors](https://arxiv.org/abs/2608.00566)
...
### [261] [Fairness Auditing: Lower Bounds on Company Manipulation](https://arxiv.org/abs/2608.00568)
...
### [262] [CoSynFlow: Conformal Symplectic Neural Flows for Cross-System Prediction of Dissipative Hamiltonian Dynamics](https://arxiv.org/abs/2608.00571)
...
### [263] [From field-scale to large-scale spectral libraries: Tabular foundation models in soil spectroscopy](https://arxiv.org/abs/2608.00608)
...
### [264] [RHEA: Reliability-Harmonized Reconstruction and Assignment for Robust Multimodal-Attributed Graph Clustering](https://arxiv.org/abs/2608.00621)
...
### [265] [Towards Effective Federated Multimodal Graph Learning via Navigating Multifaceted Heterogeneity](https://arxiv.org/abs/2608.00623)
...
### [266] [Relative Parameter Importance in Task-Agnostic Replay-Free Continual Learning](https://arxiv.org/abs/2608.00630)
...
### [267] [Learning the Pareto Frontier of Predictive Models under Distribution Shift](https://arxiv.org/abs/2608.00632)
...
### [268] [Mitigating Backdoors via Decoy Shortcuts and Knowledge Decoupling](https://arxiv.org/abs/2608.00732)
...
### [269] [An Embedded RISC-V Evaluation of Kolmogorov--Arnold Networks in Hard-Constrained Recurrent Physics-Informed Models](https://arxiv.org/abs/2608.00737)
...
### [270] [Generic Vision and Cross-Attention for Reaction Yield Prediction](https://arxiv.org/abs/2608.00776)
*Qiwei Han,Chi Zhou*
...
### [271] [Paris as a 15-Minute City: An Explainable AI Perspective](https://arxiv.org/abs/2608.00815)
...
### [272] [AdvPlan-Bench: Adversarial Evaluation of Structured Plan-Generation Agents](https://arxiv.org/abs/2608.00832)
...
### [273] [Deep Learning CNN and Recurrence Analysis for Alpha Gamma EEG Biomarkers in Fragile X Syndrome](https://arxiv.org/abs/2608.00835)
...
### [274] [Nonlinear Laplacians Improve Signed-Directed Graph Learning](https://arxiv.org/abs/2608.00836)
...
### [275] [Adaptive Quantum Physics-Informed Neural Networks for Differential Equations with Applications to Fluid Dynamics](https://arxiv.org/abs/2608.00850)
...
### [276] [HyperODE: Zero-Shot Surrogate for Simulation and Inference of Dynamical Systems](https://arxiv.org/abs/2608.00852)
*Ajitesh Srivastava*
...
### [277] [SparseKAN: Compressing Kolmogorov--Arnold Networks Across Basis Functions, Neurons, and Bits](https://arxiv.org/abs/2608.00859)
...
### [278] [Kilobyte Models: Neural Networks as a Seed and a Quantized Latent](https://arxiv.org/abs/2608.00860)
...
### [279] [GeoArbiter: Verifiability-Guided Grounding for Remote-Sensing Multimodal LLMs](https://arxiv.org/abs/2608.00877)
*Xuechen Li*
...
### [280] [AOSpec: Action and Observation Co-Speculation for Low-Latency Agent Serving](https://arxiv.org/abs/2608.00881)
...
### [281] [UpliftBench: Revealing Outcome-Regime and Objective Mismatch in Uplift Evaluation](https://arxiv.org/abs/2608.00915)
*Binshuang Li*
...
### [282] [Subtype Robustness Is Not Just Accuracy: Calibration Under Unseen Subtype Shift](https://arxiv.org/abs/2608.00928)
...
### [283] [xMICD: Explainable Representation of Multiple ICD Codes](https://arxiv.org/abs/2608.00935)
...
### [284] [Data-Driven Pinball-Loss Selection for Vertically Distributed Elastic-Net SVMs](https://arxiv.org/abs/2608.00949)
...
### [285] [Interpretable machine learning for predicting splitting strength of asphalt concrete: insights from SHAP analysis](https://arxiv.org/abs/2608.00956)
...
### [286] [One-Sided Quantile Coupling for Flow Matching](https://arxiv.org/abs/2608.00978)
...
### [287] [Beyond Gene Reconstruction: Learning Cell Representations through Complementary Transcriptomic Views](https://arxiv.org/abs/2608.00985)
...
### [288] [Who Belongs in the Eval Set? A Capability-Taxonomy-Driven Pipeline for Curating Regression Eval Sets in Agent-Extensibility Platforms](https://arxiv.org/abs/2608.01004)
...
### [289] [Hierarchical Solomonoff Induction: An Unbounded Machine Learning Model](https://arxiv.org/abs/2608.01005)
*Nathan Young*
...
### [290] [Fused Bayesian Flow Networks for Dual-Target Molecular Design](https://arxiv.org/abs/2608.01007)
...
### [291] [Caliber: Cross-Architecture Extraction-Cost Control for Score-Returning APIs](https://arxiv.org/abs/2608.01023)
...
### [292] [The Fourth Quadrant: A Stylized View of Benign Misfitting](https://arxiv.org/abs/2608.01032)
...
### [293] [Characterizing Bias in Post-Bandit Inference under Index Algorithms](https://arxiv.org/abs/2608.01069)
...
### [294] [Logit-Origin Centering for Singleton Test-Time Adaptation](https://arxiv.org/abs/2608.01074)
...
### [295] [Breaking Diversity Collapse in Spiking Pseudo-Ensembles for Efficient OOD Detection in Remote Sensing](https://arxiv.org/abs/2608.01090)
...
### [296] [Factorized AdaBoost.MH Achieves the Same Convergence Rate as AdaBoost.MH](https://arxiv.org/abs/2608.01091)
*Xin Zou,Jingyuan Xu*
...
### [297] [FL-OA: A Byzantine-Robust Federated Learning Framework with Outsourced Auditing for Intelligent Devices](https://arxiv.org/abs/2608.01095)
...
### [298] [When Do Surrogate Updates Improve Decisions? A Local Theory of Trajectory-Wise Transfer](https://arxiv.org/abs/2608.01130)
*Yuyang Shen*
...
### [299] [Policy Optimality Measurement for Multi-Vehicle Decision-Making: From Extrinsic Indicators to Intrinsic Quality](https://arxiv.org/abs/2608.01133)
...
### [300] [EulerLoRA: Rank-Driven Jump Dynamics for Calibrated Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2608.01142)
